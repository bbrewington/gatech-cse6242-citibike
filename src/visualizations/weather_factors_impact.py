...
fig.add_traces(go.Bar(x=df_t["Temperature_Avg"], 
y= df_t["num_trips_per_day"], 
name='Temperature', 
visible=True,
                      hovertemplate = "Avg_Temp: %{x} <br>Trips: %{y}", 
                      marker={'color':df_t["Temperature_Avg"], 'showscale': True}
                      )
                      )
                   ...
                   {'label': 'Dew', 
                    ...
                    'args': [{'x' :[df_d["Dew_Avg"]], 'y': [df_d["num_trips_per_day"]],
                             'name':'Dew',
                              ...
                              'marker': {'color':df_d["Dew_Avg"], 'showscale': True},
                             'visible': True}, 
                    ...
                    'args': [{'x' :[df_h["Humidity_Avg"]], 'y': [df_h["num_trips_per_day"]],
                             'name':'Humidity',
                              ...
                              'marker': {'color':df_h["Humidity_Avg"], 'showscale': True},
                             'visible': True}, 
                   ...
                   {'label': 'Wind Speed', 
                    ...
                    'args': [{'x' :[df_w["Wind Speed_Avg"]], 'y': [df_w["num_trips_per_day"]],
                             'name':'Wind Speed',
                              ...
                              'marker': {'color':df_w["Wind Speed_Avg"], 'showscale': True},
                             'visible': True}, 
                    ...
                    'args': [{'x' :[df_p["Pressure_Avg"]], 'y': [df_p["num_trips_per_day"]],
                             'name':'Pressure',
                              ...
                              'marker': {'color':df_p["Pressure_Avg"], 'showscale': True},
                             'visible': True}, 
                    ...
                    'args': [{'x' :[df_r["Precipitation_Avg"]], 'y': [df_r["num_trips_per_day"]],
                             'name':'Precipitation',
                              ...
                              'marker': {'color':df_r["Precipitation_Avg"], 'showscale': True},
                             'visible': True}, 
